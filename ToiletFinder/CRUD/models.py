...
class Hostel_info(models.Model):
    ...
    Hostel_name = models.CharField('Toilet Name',max_length=100)
    Hostel_Address = models.CharField('Toilet Address',max_length=50)
    Hostel_Ph_No = models.PositiveIntegerField('Toilet Ph No',
        null=True,blank=True)
    Hostel_Mobile_No = models.CharField('Toilet Mob No',max_length=10,
       null=True, blank=True)
    Hostel_Price = models.PositiveIntegerField('Toilet Price',blank=True,null=True)
    ...
    Hostel_lat = models.CharField('Toilet Lat',max_length=250,blank=True,null=True)
    Hostel_long = models.CharField('Toilet Long',max_length=250,blank=True,null=True)
    Hostel_type = models.CharField('Toilet Type',max_length=250,blank=True,null=True,)
