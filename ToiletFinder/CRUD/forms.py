...
class Hostel_Request_Form(forms.ModelForm):
    Hostel_Address = forms.CharField(label='Address', max_length=50,widget=forms.TextInput(attrs={'placeholder': 'Kathmandu'}))
    ...
    Hostel_type=forms.CharField(label='Toilet Type',widget=forms.Select(choices=Hostel_Type))
