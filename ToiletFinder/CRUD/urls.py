...
urlpatterns = [
    ...
    path('toilet-list/', Hostels.as_view(), name='hostel-list'),
    ...
    path('toilet-request-list/', Hostel_Request_ListView.as_view(), name='list-req-hostel'),
    path('toilet-accept/<int:pk>/', Hostel_AcceptView.accept, name='hostel-accept'),
    path('toilet-reject/<int:pk>/', Hostel_RejectView.reject, name='hostel-reject'),
    path('toilet-request-view/<int:pk>', views.hostel_DetailView, name='hostel-request-view'),

    path('delete-toilet/', DeleteGroup.deleteHostel, name='delete-hostel'),
    ...
    re_path('toilet-comments/', Hostel_Comments.get, name='hostel-comments'),

    #path("user-comment/", views.comment, name='user-comment'),
    
    #sort hostel
    path("cheap-toilet/", views.cheapSortHostel, name='cheap-hostel'),
    path("expen-toilet/", views.expenSortHostel, name='expen-hostel'),
    path("boys-toilet/",views.sortMale, name='boys-hostel'),
    path("girls-toilet/",views.sortFemale, name='girls-hostel'),

    path("search-toilet/",views.searchhostel),
    path ("toilet-detail/",views.totalhostel,name="total-hostel"),
